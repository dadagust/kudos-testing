        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'quantity_delta',
                    models.IntegerField(
                        help_text='Положительное значение увеличивает склад,'
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text='Неприменённые транзакции используются для планирования'
                        ' и не влияют на остатки.',
                        verbose_name='Транзакция применена',
                    ),
                ),
                (
                    'scheduled_for',
                    models.DateTimeField(blank=True, null=True, verbose_name='Запланировано на'),
                ),
