...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_name",
                    models.CharField(
                        blank=True, max_length=120, verbose_name="Фамилия"
                    ),
                ),
                (
                    "middle_name",
                    models.CharField(
                        blank=True, max_length=120, verbose_name="Отчество"
                    ),
                ),
                (
                    "display_name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "country",
                    models.CharField(
                        default="Россия", max_length=120, verbose_name="Страна"
                    ),
                ),
                (
                    "is_primary",
        ...
        migrations.AddIndex(
            model_name="address",
            index=models.Index(fields=["customer"], name="address_customer_idx"),
        ),
        migrations.AddIndex(
            model_name="address",
            index=models.Index(fields=["company"], name="address_company_idx"),
        ),
        migrations.AddIndex(
            model_name="address",
