# Generated by Django 5.2.7 on 2025-10-14 18:44
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'id',
                    models.UUIDField(
                        default=applications.customers.models.generate_uuid7,
                        editable=False,
                        primary_key=True,
                        serialize=False,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'customer_type',
                    models.CharField(
                        choices=[('personal', 'Физическое лицо'), ('business', 'Юридическое лицо')],
                        default='personal',
                        max_length=16,
                ...
                (
                    'middle_name',
                    models.CharField(blank=True, max_length=120, verbose_name='Отчество'),
                ),
                (
                    'display_name',
                    models.CharField(blank=True, max_length=255, verbose_name='Отображаемое имя'),
                ),
                ('email', models.EmailField(blank=True, max_length=254, verbose_name='Email')),
                ('phone', models.CharField(blank=True, max_length=32, verbose_name='Телефон')),
                (
                ...
                (
                    'gdpr_consent',
                    models.BooleanField(default=False, verbose_name='Согласие на обработку данных'),
                ),
                ('notes', models.TextField(blank=True, verbose_name='Заметки')),
                (
                    'company',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'phone_normalized',
                    models.CharField(
                        blank=True, max_length=32, verbose_name='Нормализованный телефон'
                    ),
                ),
                (
                    'position',
                    models.CharField(blank=True, max_length=120, verbose_name='Должность'),
                ),
                ('notes', models.TextField(blank=True, verbose_name='Заметки')),
